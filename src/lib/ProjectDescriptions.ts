...
'About': `
  ...
  I  work as a web developer for Hunger at Home where I develop tools that enhance operational efficiency and support impactful community services.
...
<h2 style="text-decoration: underline; font-weight:900; margin-top: 1rem"> Technologies Used: </h2>
 ...
 <h2 style="text-decoration: underline; font-weight:900; margin-top: 1rem"> Key Features: </h2>
  ...
  <li> Data visualization of real-time data </li>
  <li> Websockets for real-time updates of data of currency rates </li>
